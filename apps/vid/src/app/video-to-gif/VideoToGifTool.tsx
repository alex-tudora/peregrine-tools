...
export function VideoToGifTool() {
  ...
  const handleConvert = useCallback(async () => {
    ...
    try {
      ...
      console.error(err);
      setError(
        "GIF creation failed. FFmpeg.wasm may not be supported in your browser, or the file may be corrupted. Please try a modern Chrome or Firefox browser."
      );
      setProgress("");
    } finally {
      setIsProcessing(false);
    }
  }, [file, startTime, duration, width, fps]);
