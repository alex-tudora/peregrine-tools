...
export const metadata: Metadata = {
  title: "Video & Audio Tips | Peregrine Vid Blog",
  description:
    "Practical guides on working with video and audio files. Learn how to compress, convert, extract audio, and optimize your media.",
  alternates: {
    canonical: "https://peregrinevid.com/blog",
  },
};
    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      <div className="text-center animate-fade-in-up">
        ...
        <p className="mt-3 text-lg text-[color:var(--color-text-secondary)] leading-relaxed">
          Practical advice for working with video and audio files
        </p>
      </div>
