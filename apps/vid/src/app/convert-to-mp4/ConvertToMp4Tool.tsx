...
export function ConvertToMp4Tool() {
  ...
  const handleDownload = useCallback(() => {
    ...
    downloadBlob(resultBlob, `${baseName}.mp4`);
  }, [resultBlob, file]);
  ...
  return (
    <div className="space-y-6">
      {!file && (
        <Dropzone
          accept={[".avi", ".mov", ".mkv", ".wmv", ".flv", ".webm"]}
          multiple={false}
          onFiles={handleFiles}
            ...
            <div className="mt-5 space-y-4">
              <div className="rounded-lg bg-[color:var(--color-bg-elevated)] p-4">
                ...
                <div className="mt-2 flex items-center justify-between text-sm">
                  <span className="text-[color:var(--color-text-secondary)]">Output size</span>
                  <span className="font-medium text-[color:var(--color-text-primary)]">
