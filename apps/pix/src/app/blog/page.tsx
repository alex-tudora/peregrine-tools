...
export const metadata: Metadata = {
  title: "Image Tips & Guides | Peregrine Pix Blog",
  description:
    "Practical guides on working with images. Learn how to compress, convert, resize, and optimize your images for the web.",
  alternates: {
    canonical: "https://peregrinepix.com/blog",
  },
};
