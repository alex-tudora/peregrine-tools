...
export async function generateMetadata({
  ...
  const title = `Peregrine Pix vs ${data.name} — Honest Comparison`;
  const description = `Compare Peregrine Pix and ${data.name} on privacy, speed, cost, and features. See which image tool is right for you.`;
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://peregrinepix.com/compare/${slug}`,
      siteName: "Peregrine Pix",
      type: "website",
    },
    alternates: {
      canonical: `https://peregrinepix.com/compare/${slug}`,
    },
  };
}
    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-10 rounded-xl border border-[color:var(--color-accent)] bg-[color:var(--color-accent-light)] p-6 text-center">
        <h3 className="font-semibold text-lg text-[color:var(--color-text-primary)]">
          Try Peregrine Pix — Free, Private, Instant
        </h3>
