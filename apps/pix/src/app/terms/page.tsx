    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-[color:var(--color-text-secondary)] leading-relaxed">
        <section>
          ...
          <p className="mt-3">
            By accessing or using Peregrine Pix at peregrinepix.com (the
        ...
        <section>
          ...
          <p className="mt-3">
            Peregrine Pix provides free, browser-based image tools including but
            not limited to compressing, resizing, cropping, converting, and
            editing image files. The Service is provided as-is and is free to use
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            always verify the output of any image operation before relying on it
        ...
        <section>
          ...
          <p className="mt-3">
            The Peregrine Pix name, logo, branding, website design, and all
        ...
        <section>
          ...
          <p className="mt-3">
            To the fullest extent permitted by law, Peregrine Pix and its
