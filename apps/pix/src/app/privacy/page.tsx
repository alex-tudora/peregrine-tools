...
export const metadata: Metadata = {
  title: "Privacy Policy | Peregrine Pix",
  description:
    "Privacy policy for Peregrine Pix. Learn how we protect your data — all file processing happens in your browser with no server uploads.",
  keywords: ["privacy policy", "Peregrine Pix", "image tools privacy", "data protection", "browser-based processing"],
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-[color:var(--color-text-secondary)] leading-relaxed">
        <section>
          ...
          <p className="mt-3">
            Peregrine Pix (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is
            committed to protecting your privacy. This Privacy Policy explains
            how we handle information when you use our website at
            peregrinepix.com (the &quot;Service&quot;).
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-[color:var(--color-text-primary)]">
            File Processing &amp; Your Data
          </h2>
          <p className="mt-3">
            All image file processing happens entirely client-side in your web
            browser. Your files are never uploaded to our servers or any
            third-party servers. Files remain on your device throughout the
            entire process — from selection to download. We have no access to
            the content of your files at any time.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            address, or payment details through the use of our image tools. We do
            not track or store the files you process.
          </p>
        </section>
