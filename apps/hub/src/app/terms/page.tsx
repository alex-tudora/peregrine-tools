...
export const metadata: Metadata = {
  title: "Terms of Service | Peregrine Tools",
  description:
    "Terms of service for Peregrine Tools. Read the terms and conditions governing your use of our free online file conversion, image, video, audio, and developer tools.",
  keywords: ["terms of service", "Peregrine Tools", "online tools terms", "usage policy"],
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-[color:var(--color-text-secondary)] leading-relaxed">
        <section>
          ...
          <p className="mt-3">
            By accessing or using Peregrine Tools at peregrinetools.com or any
            of our affiliated sites including peregrinepdf.com, peregrinepix.com,
            peregrinevid.com, peregrinedev.com, and peregrinekit.com
        ...
        <section>
          ...
          <p className="mt-3">
            Peregrine Tools provides free, browser-based tools for file
            conversion, image editing, video and audio processing, text
            utilities, calculators, SEO tools, and developer utilities. The
            Service is provided as-is and is free to use for personal and
            commercial purposes. All processing happens client-side in your
            browser.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            The Peregrine Tools name, logo, branding, website design, and all
        ...
        <section>
          ...
          <p className="mt-3">
            To the fullest extent permitted by law, Peregrine Tools and its
