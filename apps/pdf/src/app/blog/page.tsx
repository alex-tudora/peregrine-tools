...
export const metadata: Metadata = {
  title: "PDF Tips & Guides | Peregrine PDF Blog",
  description:
    "Practical guides on working with PDF files. Learn how to compress, merge, convert, and optimize your documents.",
  alternates: {
    canonical: "https://peregrinepdf.com/blog",
  },
};
    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      <div className="text-center animate-fade-in-up">
        ...
        <p className="mt-3 text-lg text-[color:var(--color-text-secondary)] leading-relaxed">
          Practical advice for working with PDF files
        </p>
      </div>
