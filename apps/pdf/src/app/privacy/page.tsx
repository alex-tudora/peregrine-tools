...
export const metadata: Metadata = {
  title: "Privacy Policy | Peregrine PDF",
  description:
    "Privacy policy for Peregrine PDF. Learn how we protect your data — all file processing happens in your browser with no server uploads.",
  keywords: ["privacy policy", "Peregrine PDF", "PDF tools privacy", "data protection", "browser-based processing"],
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-[color:var(--color-text-secondary)] leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-3">
            All PDF file processing happens entirely client-side in your web
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            address, or payment details through the use of our PDF tools. We do
