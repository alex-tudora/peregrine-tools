...
export const metadata: Metadata = {
  title: "Developer Tips & Guides | Peregrine Dev Blog",
  description:
    "Practical guides for developers. Learn about JSON formatting, regex patterns, Base64 encoding, and other everyday developer tasks.",
  alternates: {
    canonical: "https://peregrinedev.com/blog",
  },
};
    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      <div className="text-center animate-fade-in-up">
        ...
        <p className="mt-3 text-lg text-[color:var(--color-text-secondary)] leading-relaxed">
          Practical advice for everyday developer tasks
        </p>
      </div>
