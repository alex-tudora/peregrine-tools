...
export const metadata: Metadata = {
  title: "Terms of Service | Peregrine Dev",
  description:
    "Terms of service for Peregrine Dev. Read the terms and conditions governing your use of our free online developer tools.",
  keywords: ["terms of service", "Peregrine Dev", "developer tools terms", "usage policy"],
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-[color:var(--color-text-secondary)] leading-relaxed">
        <section>
          ...
          <p className="mt-3">
            By accessing or using Peregrine Dev at peregrinedev.com (the
        ...
        <section>
          ...
          <p className="mt-3">
            Peregrine Dev provides free, browser-based developer tools
            including but not limited to JSON formatting, regex testing, base64
            encoding, hash generation, and more. The Service is provided as-is
            and is free to use for personal and commercial purposes. All
        ...
        <section>
          ...
          <p className="mt-3">
            The Peregrine Dev name, logo, branding, website design, and all
        ...
        <section>
          ...
          <p className="mt-3">
            To the fullest extent permitted by law, Peregrine Dev and its
