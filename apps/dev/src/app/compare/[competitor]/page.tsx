...
export async function generateMetadata({
  ...
  const title = `Peregrine Dev vs ${data.name} — Honest Comparison`;
  const description = `Compare Peregrine Dev and ${data.name} on ease of use, features, privacy, and more. See which developer toolkit is right for you.`;
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://peregrinedev.com/compare/${slug}`,
      siteName: "Peregrine Dev",
      type: "website",
    },
    alternates: {
      canonical: `https://peregrinedev.com/compare/${slug}`,
    },
  };
}
    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-10 rounded-xl border border-[color:var(--color-accent)] bg-[color:var(--color-accent-light)] p-6 text-center">
        <h3 className="font-semibold text-lg text-[color:var(--color-text-primary)]">
          Try Peregrine Dev — Free, Private, Instant
        </h3>
