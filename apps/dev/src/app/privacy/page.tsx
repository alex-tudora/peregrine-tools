    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-[color:var(--color-text-secondary)] leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-3">
            All developer tool operations happen entirely client-side in your
            web browser. Your data is never uploaded to our servers or any
            third-party servers. Data remains on your device throughout the
            entire process. We have no access to the content you process at any
            time.
          </p>
        </section>
