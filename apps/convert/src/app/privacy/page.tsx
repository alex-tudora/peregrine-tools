    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-[color:var(--color-text-secondary)] leading-relaxed">
        <section>
          ...
          <p className="mt-3">
            Convert-a-Lot (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;),
            operated by Peregrine Tools, is committed to protecting your privacy.
            This Privacy Policy explains how we handle information when you use
            our website at convert-a-lot.com (the &quot;Service&quot;).
            Convert-a-Lot routes users to Peregrine Tools sites including
            peregrinepdf.com, peregrinepix.com, peregrinevid.com,
            peregrinedev.com, and peregrinekit.com for actual file processing.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            operations happen entirely client-side in your web browser on the
            respective Peregrine Tools sites. Your data is never uploaded to our
            servers or any third-party servers. Data remains on your device
            throughout the entire process. We have no access to the content you
            process at any time.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            Convert-a-Lot directs users to Peregrine Tools sites for file
            processing. We may also use third-party services for analytics and
            advertising. These services have their own privacy policies
            governing their use of your information. We encourage you to review
            the privacy policies of any third-party services that interact with
            our site.
          </p>
        </section>
