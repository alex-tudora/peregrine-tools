...
export async function generateMetadata({
  ...
  const title = `Convert-a-Lot vs ${data.name} — Honest Comparison`;
  const description = `Compare Convert-a-Lot and ${data.name} on privacy, speed, cost, and features. See which file converter is right for you.`;
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://convert-a-lot.com/compare/${slug}`,
      siteName: "Convert-a-Lot",
      type: "website",
    },
    alternates: {
      canonical: `https://convert-a-lot.com/compare/${slug}`,
    },
  };
}
    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-10 rounded-xl border border-[color:var(--color-accent)] bg-[color:var(--color-accent-light)] p-6 text-center">
        <h3 className="font-semibold text-lg text-[color:var(--color-text-primary)]">
          Try Convert-a-Lot — Free, Private, Instant
        </h3>
