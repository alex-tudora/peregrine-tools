...
export async function generateMetadata({
  ...
  const title = `Peregrine Kit vs ${data.name} — Honest Comparison`;
  const description = `Compare Peregrine Kit and ${data.name} on privacy, speed, cost, and features. See which tool is right for you.`;
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://peregrinekit.com/compare/${slug}`,
      siteName: "Peregrine Kit",
      type: "website",
    },
    alternates: {
      canonical: `https://peregrinekit.com/compare/${slug}`,
    },
  };
}
    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-10 rounded-xl border border-[color:var(--color-accent)] bg-[color:var(--color-accent-light)] p-6 text-center">
        <h3 className="font-semibold text-lg text-[color:var(--color-text-primary)]">
          Try Peregrine Kit — Free, Private, Instant
        </h3>
