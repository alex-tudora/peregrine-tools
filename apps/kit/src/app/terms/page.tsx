    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-slate-700 leading-relaxed">
        <section>
          ...
          <p className="mt-3">
            By accessing or using Peregrine Kit at peregrinekit.com (the
        ...
        <section>
          ...
          <p className="mt-3">
            Peregrine Kit provides free, browser-based text tools, calculators,
            and SEO utilities including but not limited to word counting, case
            conversion, percentage calculation, meta tag generation, and more.
            The Service is provided as-is and is free to use for personal and
        ...
        <section>
          ...
          <p className="mt-3">
            The Peregrine Kit name, logo, branding, website design, and all
        ...
        <section>
          ...
          <p className="mt-3">
            To the fullest extent permitted by law, Peregrine Kit and its
