...
export const metadata: Metadata = {
  title: "Tips & Guides | Peregrine Kit Blog",
  description:
    "Practical guides on writing, SEO, and everyday math. Learn how to use readability scores, meta tags, compound interest, and more.",
  alternates: {
    canonical: "https://peregrinekit.com/blog",
  },
};
    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      <div className="text-center animate-fade-in-up">
        ...
        <p className="mt-3 text-lg text-[color:var(--color-text-secondary)] leading-relaxed">
          Practical advice for writing, SEO, and everyday math
        </p>
      </div>
