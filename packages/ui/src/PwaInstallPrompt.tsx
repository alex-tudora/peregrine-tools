  ...
  return (
    <div className="mt-4 flex items-center gap-3 rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-bg-elevated)] px-4 py-3 animate-arrive">
      ...
      <button
        ...
        className="shrink-0 rounded-lg bg-[color:var(--color-accent)] px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-[color:var(--color-accent-hover)]"
      >
        Install
      </button>
      <button
